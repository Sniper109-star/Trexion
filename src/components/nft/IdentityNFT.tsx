  ...
  return (
    <div className="relative w-full max-w-md mx-auto">
      ...
      <div className="relative bg-neutral-900 border border-neutral-800 rounded-2xl p-6 shadow-2xl">
        <div className="text-center border-b border-neutral-800 pb-6 mb-6">
        ...
        <div className="space-y-3 text-sm">
          <div className="flex justify-between">
            ...
            <span className="text-white capitalize">{profile.userType.replace("_", " ")}</span>
          </div>
          <div className="flex justify-between">
            <span className="text-neutral-400">Reputation</span>
            <span className="text-white">{profile.reputation}/100</span>
          </div>
          <div className="flex justify-between">
