  ...
  return (
    <div className="space-y-8">
      <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 shadow-lg">
        <h2 className="text-xl font-bold text-white mb-4">AI Matching Engine</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm text-neutral-400 mb-1">Looking for</label>
            <select
              value={searchType}
          ...
          {searchType === "creator" && (
            <>
              ...
              <div>
                <label className="block text-sm text-neutral-400 mb-1">Min Followers</label>
                <input
                  type="number"
                  value={minFollowers}
          ...
          {searchType === "startup" && (
            <>
              ...
              <div>
                <label className="block text-sm text-neutral-400 mb-1">Min Community Size</label>
                <input
                  type="number"
                  value={minCommunity}
          ...
          <div>
            <label className="block text-sm text-neutral-400 mb-1">Min Reputation (0-100)</label>
            <input
              type="number"
              value={minReputation}
        ...
        <button
          ...
          className="mt-6 w-full md:w-auto px-6 py-2.5 rounded-lg bg-purple-600 hover:bg-purple-500 text-white font-medium transition-colors"
        >
          Find Matches
        </button>
      </div>
...
function MatchCard({ result }: { result: MatchResult }) {
  ...
  return (
    <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-5 shadow-lg hover:border-neutral-700 transition-colors">
