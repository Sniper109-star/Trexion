    ...
    <div className="min-h-screen bg-neutral-950 text-white">
      ...
      <main className="px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-3xl sm:text-4xl font-bold mb-6">About TREXION Identity NFTs</h1>
          <div className="space-y-6 text-neutral-300 text-sm sm:text-base">
            <p>
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-white pt-2">How It Works</h2>
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-white pt-2">NFT Types</h2>
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-white pt-2">AI Matching Engine</h2>
            <p>
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-white pt-2">Onchain Profiles</h2>
            <p>
